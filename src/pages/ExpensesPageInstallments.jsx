...
import { getExpenseBillingMonth, getMonthKey, getMonthLabel } from "../utils/installmentUtils";

export default function ExpensesPageInstallments() {
  const {
    expenses,
    categories,
    people,
  ...
  const sortedExpenses = [...expenses].sort((a, b) => {
    const month = getExpenseBillingMonth(b, cards).localeCompare(getExpenseBillingMonth(a, cards));
    return month || String(b.data).localeCompare(String(a.data));
  });
